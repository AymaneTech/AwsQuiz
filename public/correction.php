...
<head>
    ...
    <link rel="stylesheet" href="../App/Views/assets/css/correction.css">
    <script src="https://cdn.tailwindcss.com"></script>
    <title>Aws Quiz | Correction</title>
</head>
<body class="bg-gray-100 overflow-x-hidden">
<div class="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-700 px-64">
    <ol class="grid grid-cols-3 text-sm font-medium text-black">
        ...
        <li class="relative flex justify-center text-blue-600">
                                                                <span class="absolute -bottom-[1.75rem] rounded-full bg-blue-600 text-white">
                                                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                                                        </svg>
                                                                </span>
        ...
        <li class="relative flex justify-end">
            ...
            <span class="hidden sm:block text-blue-600"> Result </span>
...
<script src="../App/Views/assets/js/correction.js"></script>
</body>
</html>